 ...
 */
public class JUnitXMLTestReportConverter extends StringTemplateTestReportConverter
        implements TestReportConverter {

    public JUnitXMLTestReportConverter(Writer out) throws IOException {
        super(out, "JUnitXML");
    }
