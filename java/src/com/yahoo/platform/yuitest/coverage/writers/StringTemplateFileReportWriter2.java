 ...
 */
public class StringTemplateFileReportWriter2 implements FileReportWriter {

    protected Writer out;
    protected StringTemplateGroup templateGroup;

    public StringTemplateFileReportWriter2(Writer out, String format) throws IOException {
        this.out = out;
    ...
    private StringTemplateGroup getStringTemplateGroup(String format) throws IOException{
        ...
        InputStream stgstream = StringTemplateFileReportWriter2.class.getResourceAsStream(format + "FileReportTemplates.stg");
