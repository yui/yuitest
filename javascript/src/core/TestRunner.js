    ...
    YUITest.TestRunner = function(){
        ...
        TestRunner.prototype = YUITest.Util.mix(new YUITest.EventTarget(), {
            ...
            */
             ...
             * @param {YUITestNode} parentNode The node to add the test case to as a child.
           ...
           _addTestCaseToTestTree : function (parentNode, testCase){
             ...
             * @param {YUITestNode} parentNode The node to add the test suite to as a child.
             ...
             * @param {YUITestNode} node The TestNode representing the test object.
             ...
             * @return {YUITestNode} The next node in the test tree or null if the end is reached.
             * @private
             * @static
             * @method _next
             */
             ...
             * @method _runTest
             * @param {YUITestNode} node The TestNode representing the test to run.
             * @static
             * @private
             */
