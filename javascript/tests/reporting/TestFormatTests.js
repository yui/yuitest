(function(){
    ...
    var suite = new YUITest.TestSuite("Formatting Tests");
    ...
    suite.add(new YUITest.TestCase({
        ...
        /*testJsonFormat : function(){
            var json = YUITest.TestFormat.JSON(this.report);
            var expectedJson = 
        ...
        testXmlFormat : function(){
            var xml = YUITest.TestFormat.XML(this.simpleReport);
            var expectedXml = 
        ...
        testJUnitXmlFormat : function(){
            var xml = YUITest.TestFormat.JUnitXML(this.simpleReport);
            var expectedXml = 
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                "<testsuites>" +
        ...
        testTAPFormat : function(){
            var text = YUITest.TestFormat.TAP(this.simpleReport);
            var expectedText = 
                "1..5\n" + 
